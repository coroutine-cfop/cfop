...
inline ThrowCompletionOr<Value> typed_array_get_element(TypedArrayBase const& typed_array, CanonicalIndex property_index)
{
    ...
    Checked<u64> byte_index_in_buffer = property_index.as_index();
    ...
    dbgln("typed_array_get_element(): property_index:{}, offset:{}, byte_index_in_buffer:{}", property_index.as_index(), offset, byte_index_in_buffer.value());
...
{
    dbgln("***** MEMORY LEAK, INTRODUCE IN THE WEBSITE = {} *****", &typed_array);
    ...
    if (typed_array.content_type() == TypedArrayBase::ContentType::BigInt)
        num_value = TRY(value.to_number(vm));//num_value = TRY(value.to_bigint(vm));
    ...
    dbgln("typed_array_set_element(): num_value:{}, property_index:{}, offset:{}, byte_index_in_buffer:{}", num_value, property_index.as_index(), offset, byte_index_in_buffer.value());
...
public:
    ...
    virtual ThrowCompletionOr<Optional<PropertyDescriptor>> internal_get_own_property(PropertyKey const& property_key) const override
    {
        ...
        dbgln("calling internal_get_own_property()");
    ...
    {
        dbgln("calling internal_set():: value:{}, property_key:{}", value, (u64)property_key.as_number());
