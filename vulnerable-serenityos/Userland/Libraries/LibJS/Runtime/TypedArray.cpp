...
{
    dbgln("Array initially at data:{:p}", array_buffer.buffer().data());
    //if(array_buffer.)
    ...
    // 9. Else,
        ...
        // b. Else,
            ...
            dbgln("Array with byte_length:{} and array_length {} created! Offset:{}", new_byte_length.value(), new_byte_length.value() / element_size, offset);
    ...
    dbgln("Created array at data:{:p}", typed_array.viewed_array_buffer()->buffer().data());
    ...
    {                                                                                                                       \
        ...
        if (first_argument.is_object()) {                                                                                   \
            ...
            if (first_argument.as_object().is_typed_array()) {                                                              \
                ...
                dbgln("array_buffer size:{}", array_buffer.byte_length()); \
